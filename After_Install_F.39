...
sleep 3
 ...
 sleep 3
 echo " "
 sudo dnf install -y  https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$(rpm -E %fedora).noarch.rpm 2>> /tmp/ErroAfterInstall.log
 ...
 sleep 3
 echo " "
 sudo dnf install -y https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm 2>> /tmp/ErroAfterInstall.log
 sleep 3
...
sudo dnf install gstreamer1-plugins-{bad-\*,good-\*,base} gstreamer1-plugin-openh264 gstreamer1-libav --exclude=gstreamer1-plugins-bad-free-develsudo dnf install gstreamer1-plugins-{bad-\*,good-\*,base} gstreamer1-plugin-openh264 gstreamer1-libav --exclude=gstreamer1-plugins-bad-free-devel

rpm-ostree install ffmpegthumbnailer
rpm-ostree install heif-pixbuf-loader libheif-freeworld libheif-tools
...
sudo usermod -aG vboxusers diomenezes 
